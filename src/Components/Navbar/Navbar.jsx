...
const Navbar = () => {
  ...
  <div className="navbar-start">
    <div className="dropdown">
      ...
      <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box font-bold text-[16px] text-black text-2xl w-52">
       {NavLinks}
      </ul>
    </div>
    <Link to="/">
   ...
   <img src={logo} className="w-16"  alt="" />
    ...
    <p className="normal-case text-2xl font-semibold text-black">Job Buzz</p>
   </div>
   </Link>
  </div>
  <div className="navbar-center hidden lg:flex">
    <ul className="menu menu-horizontal px-1 text-[16px]  text-black font-bold">
      {NavLinks}
    </ul>
  </div>
